    ...
    public BiomeInit(BootstrapContext<Biome> context) {
        ...
        register(ATLANTEAN_GARDEN_KEY, new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(new MobSpawnSettings.Builder()
                        ...
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.SEAHORSE.get(), 25, 2, 2))
                        .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.JELLYFISH.get(), 25, 2, 2))
        ...
        register(ATLANTEAN_ISLANDS_BIOME_KEY, new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(new MobSpawnSettings.Builder()
                        ...
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.ATLANTEAN_ZOMBIE_STARFISH.get(), 25, 2, 2))
