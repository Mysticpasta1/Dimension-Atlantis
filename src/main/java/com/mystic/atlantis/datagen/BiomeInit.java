    ...
    public BiomeInit(BootstrapContext<Biome> context) {
        ...
        register(ATLANTEAN_GARDEN_KEY, new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(new MobSpawnSettings.Builder()
                        ...
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.STARFISH.get(), 25, 3, 5))
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.SEAHORSE.get(), 25, 2, 7))
                        .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.JELLYFISH.get(), 25, 2, 3))
                        .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.SHRIMP.get(), 25, 4, 5))
                        .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(EntityType.TROPICAL_FISH, 25, 8, 20))
                        .build()
                )
        ...
        register(ATLANTEAN_ISLANDS_BIOME_KEY, new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(new MobSpawnSettings.Builder()
                        ...
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.ATLANTEAN_ZOMBIE_STARFISH.get(), 25, 3, 6))
        ...
        register(COCONUT_ISLES_KEY, new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(new MobSpawnSettings.Builder()
                        //.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.SEA_SERPENT.get(), 25, 1, 2))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE, 25, 4, 6))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.DROWNED, 25, 4, 6))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.SKELETON, 25, 4, 6))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.CREEPER, 25, 4, 6))
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(EntityType.SQUID, 25, 2, 3))
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.SEAHORSE.get(), 25, 2, 7))
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.STARFISH.get(), 25, 3, 5))
                        .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.JELLYFISH.get(), 25, 2, 3))
        ...
        register(GOO_LAGOONS_KEY, new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(new MobSpawnSettings.Builder()
                        ...
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.SEAHORSE.get(), 25, 2, 7))
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.STARFISH.get(), 25, 3, 5))
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.LEVIATHAN.get(), 25, 2, 3))
                        .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.JELLYFISH.get(), 25, 2, 3))
                        .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.SHRIMP.get(), 25, 4, 5))
                        .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(EntityType.TROPICAL_FISH, 25, 8, 20))
                        .build()
        ...
        register(JELLYFISH_FIELDS_KEY, new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(new MobSpawnSettings.Builder()
                        ...
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.CRAB.get(), 25, 2, 4))
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.STARFISH.get(), 25, 3, 5))
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.LEVIATHAN.get(), 25, 5, 10))
                        .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.JELLYFISH.get(), 25, 5, 10))
                        .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(EntityType.TROPICAL_FISH, 25, 8, 20))
                        .build()
                )
                .generationSettings(new BiomeGenerationSettings.Builder(holdergetter, holdergetter1)
        ...
        register(VOLCANIC_DARKSEA_KEY, new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(new MobSpawnSettings.Builder()
                        //.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.SEA_SERPENT.get(), 25, 1, 2))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.DROWNED, 25, 6, 10))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.SKELETON, 25, 6, 10))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.ATLANTEAN_ZOMBIE_STARFISH.get(), 25, 4, 8))
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(EntityType.SQUID, 25, 2, 3))
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.CRAB.get(), 25, 2, 4))
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.STARFISH.get(), 25, 3, 5))
                        .addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.LEVIATHAN.get(), 25, 4, 5))
                        .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(AtlantisEntityInit.JELLYFISH.get(), 25, 2, 3))
                        .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(EntityType.TROPICAL_FISH, 25, 8, 20))
                        .build()
                )
