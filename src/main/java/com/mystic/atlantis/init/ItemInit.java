...
public class ItemInit {
    ...
    public static final DeferredHolder<Item, Item> AQUAMARINE_HAMMER = register("aquamarine_hammer", properties -> new AquamarineHammer());

    public static final DeferredHolder<Item, Item> ORICHALCUM_AXE = register("orichalcum_axe", properties -> new AtlanteanAxeItem(ToolInit.ORICHALCUM, 3));
    public static final DeferredHolder<Item, Item> ORICHALCUM_PICKAXE = register("orichalcum_pickaxe", properties -> new AtlanteanPickaxeItem(ToolInit.ORICHALCUM, 2));
    public static final DeferredHolder<Item, Item> ORICHALCUM_SHOVEL = register("orichalcum_shovel", properties -> new AtlanteanShovelItem(ToolInit.ORICHALCUM, 1));
    public static final DeferredHolder<Item, Item> ORICHALCUM_HOE = register("orichalcum_hoe", properties -> new AtlanteanHoeItem(ToolInit.ORICHALCUM, 2));
    public static final DeferredHolder<Item, Item> ORICHALCUM_SWORD = register("orichalcum_sword", properties -> new AtlanteanSwordItem(ToolInit.ORICHALCUM, 4));
    public static final DeferredHolder<Item, Item> ORICHALCUM_HAMMER = register("orichalcum_hammer", properties -> new OrichalcumHammer());
