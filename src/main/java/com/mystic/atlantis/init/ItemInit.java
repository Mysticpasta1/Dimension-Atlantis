...
public class ItemInit {
    ...
    //public static final DeferredHolder<Item, Item> AQUAMARINE_HAMMER = register("aquamarine_hammer", properties -> new AquamarineHammer(ToolInit.AQUAMARINE, 3));
    ...
    //public static final DeferredHolder<Item, Item> ORICHALCUM_HAMMER = register("orichalcum_hammer", properties -> new OrichalcumHammer(ToolInit.ORICHAClUM, 5));
