...
public class BlockInit {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(Reference.MODID, BLOCK);

    public static final Map<LinguisticGlyph, Map<DyeColor, RegistrySupplier<Block>>> DYED_LINGUISTICS = new HashMap<>();
    public static final Map<LinguisticGlyph, RegistrySupplier<Block>> NON_LINGUISTICS = new HashMap<>();
    public static final Map<DyeColor, RegistrySupplier<Block>> COLORED_SHELL_BLOCKS = new HashMap<>();
    public static final Map<DyeColor, RegistrySupplier<Block>> CRACKED_SHELL_BLOCKS = new HashMap<>();
    public static final Map<DyeColor, RegistrySupplier<Block>> CRACKED_MOSSY_SHELL_BLOCKS = new HashMap<>();
    public static final Map<DyeColor, RegistrySupplier<Block>> MOSSY_SHELL_BLOCKS = new HashMap<>();
    ...
    //Fluid Blocks
    public static final RegistrySupplier<LiquidBlock> JETSTREAM_WATER_BLOCK = BLOCKS.register("jetstream_water",
            () -> new ArchitecturyLiquidBlock(FluidInit.JETSTREAM_WATER, BlockBehaviour.Properties.ofFullCopy(Blocks.WATER)));
    public static final RegistrySupplier<ArchitecturyLiquidBlock> SALTY_SEA_WATER_BLOCK = BLOCKS.register("salty_sea_water",
            () -> new ArchitecturyLiquidBlock(FluidInit.SALTY_SEA_WATER, BlockBehaviour.Properties.ofFullCopy(Blocks.WATER)));

    //public static final RegistrySupplier<LiquidBlock> COCONUT_MILK = BLOCKS.register("coconut_milk",
    ...
    public static final RegistrySupplier<AtlanteanSignBlock> ATLANTEAN_SIGNS = registerOnlyBlock("atlantean_sign", () -> new AtlanteanSignBlock(BlockBehaviour.Properties.of(), ATLANTEAN));
    ...
    public static final RegistrySupplier<EnenmomyBlock> ENENMOMY_BLOCK = registerBlock("enenmomy", EnenmomyBlock::new);
    ...
    public static final RegistrySupplier<DropExperienceBlock> AQUAMARINE_ORE = registerBlock("aquamarine_ore", () -> new DropExperienceBlock(ConstantInt.of(5), BlockBehaviour.Properties.of()
            .sound(SoundType.STONE)
            .requiresCorrectToolForDrops()
            .strength(3.0F, 15.0F)
            .lightLevel((state) -> 2)));

    public static final RegistrySupplier<DropExperienceBlock> AQUAMARINE_DEEPSLATE_ORE = registerBlock("aquamarine_deepslate_ore", () -> new DropExperienceBlock(ConstantInt.of(5), BlockBehaviour.Properties.of()
            .sound(SoundType.STONE)
            .requiresCorrectToolForDrops()
            .strength(5.0F, 15.0F)
            .lightLevel((state) -> 4)));
    ...
    public static final RegistrySupplier<AtlanteanSaplingBlock> ATLANTEAN_SAPLING = registerBlock("atlantean_sapling", () ->
            new AtlanteanSaplingBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING)));

    public static final RegistrySupplier<AtlanteanPalmSaplingBlock> ATLANTEAN_PALM_SAPLING = registerBlock("palm_sapling", () ->
    ...
    public static <L extends LiquidBlock> RegistrySupplier<L> registerFluidBlock(String name, Supplier<L> block) {
        return BLOCKS.register(name, block);
    }
    ...
    public static RegistrySupplier<Block> getLinguisticBlock(LinguisticGlyph symbol, DyeColor color) {
        if (color != null) {
