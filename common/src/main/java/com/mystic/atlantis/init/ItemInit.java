...
public class ItemInit {
    ...
    //SPAWN EGGS
    public static final Supplier<Item> ATLANTEAN_CRAB_EGG = register("atlantean_crab_egg",() -> new SpawnEggItem(AtlantisEntityInit.CRAB.get(), 0x800002, 0xff0f45, new Item.Properties()));
    public static final Supplier<Item> ATLANTEAN_JELLYFISH_EGG = register("atlantean_jellyfish_egg", () -> new SpawnEggItem(AtlantisEntityInit.JELLYFISH.get(), 0x00458a, 0x0582ff, new Item.Properties()));
    public static final Supplier<Item> ATLANTEAN_SHRIMP_EGG = register("atlantean_shrimp_egg", () -> new SpawnEggItem(AtlantisEntityInit.SHRIMP.get(), 0xff0000, 0xff8000, new Item.Properties()));
    public static final Supplier<Item> LEVIATHAN_EGG = register("leviathan_egg", () -> new SpawnEggItem(AtlantisEntityInit.LEVIATHAN.get(), 0x01ddddd, 0xaddedb, new Item.Properties()));

    public static final Supplier<Item> ATLANTEAN_SEAHORSE_EGG = register("atlantean_seahorse_egg", () -> new SpawnEggItem(AtlantisEntityInit.SEAHORSE.get(), 0xf6eb3e, 0xcfc85b, new Item.Properties()));

    public static final Supplier<Item> COCONUT_CRAB_EGG = register("coconut_crab_egg", () -> new SpawnEggItem(AtlantisEntityInit.COCONUT_CRAB.get(), 0x800002, 0xff0f45, new Item.Properties()));
    ...
    public static final Supplier<Item> SHRIMP = register("shrimp", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(5).saturationModifier(0.2f).arch$effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 100), 0.05f).build())));
    public static final Supplier<Item> COOKED_SHRIMP = register("cooked_shrimp", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.4f).build())));
    ...
    public static final Supplier<Item> ATLANTEAN_FIRE_MELON_FRUIT_SPIKED = register("atlantean_fire_melon_fruit_spiked", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(1).saturationModifier(1).arch$effect(() -> new MobEffectInstance(MobEffects.HARM, 60), 1.0f).build())));
    ...
    //Fluid Buckets
    public static final RegistrySupplier<Item> JETSTREAM_WATER_BUCKET = ITEMS.register("jetstream_water_bucket", () -> new ArchitecturyBucketItem(FluidInit.JETSTREAM_WATER,
                    new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    public static final RegistrySupplier<Item> SALTY_SEA_WATER_BUCKET = ITEMS.register("salty_sea_water_bucket",
            () -> new ArchitecturyBucketItem(FluidInit.SALTY_SEA_WATER,
                    new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    public static final Supplier<Item> ORICHALCUM_HELMET = register("orichalcum_helmet", () -> new ItemArmorOrichalcum(BasicArmorMaterial.ARMOR_ORICHALCUM, ArmorItem.Type.HELMET, new Item.Properties()));
    public static final Supplier<Item> ORICHALCUM_CHESTPLATE = register("orichalcum_chestplate", () -> new ItemArmorOrichalcum(BasicArmorMaterial.ARMOR_ORICHALCUM, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final Supplier<Item> ORICHALCUM_LEGGINGS= register("orichalcum_leggings", () -> new ItemArmorOrichalcum(BasicArmorMaterial.ARMOR_ORICHALCUM, ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final Supplier<Item> ORICHALCUM_BOOTS = register("orichalcum_boots", () -> new ItemArmorOrichalcum(BasicArmorMaterial.ARMOR_ORICHALCUM, ArmorItem.Type.BOOTS, new Item.Properties()));
