...
public record BlockType(Supplier<Block> block, Supplier<SlabBlock> slab, Supplier<WallBlock> wall, Supplier<FenceBlock> fence, Supplier<FenceGateBlock> fenceGate, Supplier<StairBlock> stairs, Supplier<DoorBlock> door, Supplier<TrapDoorBlock> trapDoor, Supplier<ButtonBlock> button, Supplier<PressurePlateBlock> pressurePlate) {
    ...
    public static BlockType of(Supplier<Block> blockBase, Supplier<SlabBlock> blockSlab, Supplier<WallBlock> blockWall, Supplier<FenceBlock> blockFence, Supplier<FenceGateBlock> blockGateBlock, Supplier<StairBlock> blockStairs, Supplier<DoorBlock> blockDoor, Supplier<TrapDoorBlock> blockTrapDoor, Supplier<ButtonBlock> blockButton, Supplier<PressurePlateBlock> pressurePlate) {
        var blockType = new BlockType(blockBase, blockSlab, blockWall, blockFence, blockGateBlock, blockStairs, blockDoor, blockTrapDoor, blockButton, pressurePlate);
