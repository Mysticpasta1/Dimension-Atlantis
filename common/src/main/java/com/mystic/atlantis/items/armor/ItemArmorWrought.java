...
public class ItemArmorWrought extends ArmorItem {
    ...
    public ItemArmorWrought(Holder<ArmorMaterial> material, Type slot, Properties settings) {
    ...
    private void addStatusEffectForMaterial(Player player, Holder<ArmorMaterial> mapArmorMaterial, Holder<MobEffect> mapStatusEffect) {
        ...
        if (hasCorrectArmorOn(mapArmorMaterial, player) && !hasPlayerEffect) {
            player.addEffect(new MobEffectInstance(mapStatusEffect, 2001, 1, false, false));
        }
    }
